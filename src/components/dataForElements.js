/*from this file all variables are named exports;
...
dropdownListElements = this variable contains all the possible options for all the dropdown lists;
it is exported to the ParentSettingsPanel.jsx and ItemSettingsPanel.jsx

numberOfElementsToStartWith = this variable contains a number; this is how many actionBoxes to show on the DemoPanel at the beginning; 
later the user can change their nuber; (actionBox = colored box with a huge letter on the right side)
this variable is exported to NumberSettingsPanel.jsx and App.js

uniqueIdentifiers = these letters act as uniqe ID-s for the actionBoxes on DemoPanel. 
The lenght also puts an upper limit how many aqctionBoxes can the user create (<80);
it is exported to DemoPanel.jsx -for using as id-s and sings on actionBoxes, 
also to Button.jsx to determine the maximum number allowed when pressing on plus btn
the reason that this is a string and not an array is only my personal preference to avoid entering so many '' signs*/

const dropdownListElements = {
  flexDirectionData: {
    id: "flexDirection",//id for map()FN
    selectName: "flex direction",//label text
    options: ["row", "row-reverse", "column", "column-reverse"],//dropdown options
  },
  flexWrapData: {
    id: "flexWrap",
    selectName: "flex wrap",

    options: ["nowrap", "wrap", "wrap-reverse"],
  },
  justifyContentData: {
    id: "justifyContent",
    selectName: "justify content",
...
const numberOfElementsToStartWith=5;
...
export {dropdownListElements, numberOfElementsToStartWith, uniqueIdentifiers, additionalInformation};
